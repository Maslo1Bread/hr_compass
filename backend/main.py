...
(function () {
  ...
  window.doLogin = async function () {
    ...
    applyRoleUi();
    msgs.innerHTML = '';
    bot('Здравствуйте, ' + (employee.name || 'сотрудник') + '! Вы вошли как: ' + (employee.role || 'worker') + '. 💡 Напишите мне вопрос — помогу с отпуском, авансом, справками, ДМС, КЭДО и обращением в HR.');
  };
